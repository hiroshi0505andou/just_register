      ...
      <form action="../actions/edit-user.php" method="POST" enctype="multipart/form-data">
        <div class="row justify-content-center mb-3">
          ...
          <?php }else{ ?>
            ...
            <?php } ?>
            <input type="file" class="form-control mt-2" accept="image/*" name="photo" id="">
            </div>
        </div>
        <div class="mb-3">
          <label for="first_name" class="form-label">First name</label>
          <input type="text" class="form-control" name="first_name" id="first_name"required autofocus value="<?= $user['first_name'] ?>">
        </div>
        <div class="mb-3">
